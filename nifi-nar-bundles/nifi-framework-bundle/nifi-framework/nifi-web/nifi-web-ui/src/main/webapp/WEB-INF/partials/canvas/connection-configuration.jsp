...
<div id="connection-configuration" layout="column" class="hidden large-dialog">
    <div class="connection-configuration-tab-container dialog-content">
        ...
        <div id="connection-configuration-tabs-content">
            ...
            <div id="connection-reporting-tab-content" class="configuration-tab">
                <div class="settings-left">
                    <div class="setting">
                        <div class="connection-report-metrics-setting">
                            ...
                            <div class="editable setting-field">
                                <div id="connection-report-metrics-combo"></div>
                            </div>
                        </div>
                    </div>
                    <div class="setting">
                        <div class="connection-metric-prefix-setting">
                            ...
                            <div class="editable setting-field">
                                <input type="text" id="connection-metric-prefix" name="connection-metric-prefix" class="small-setting-input"/>
                            </div>
                        </div>
                    </div>
                </div>
